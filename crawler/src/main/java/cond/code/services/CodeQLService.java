...
public class CodeQLService {
    ...
    public CodeQLService(GitHubRepository repo) {
        this.repo = repo;
                ...
                try {
                    ...
                    if (!releaseBranches.isEmpty()) {
                        String latestVersion = releaseBranches.stream()
                                ...
                                .map(CodeQLService.Version::new)
                                .max(Comparator.naturalOrder())
                                .map(CodeQLService.Version::toString)
                                .orElse(null);
    ...
    public static class Version implements Comparable<CodeQLService.Version> {
        ...
        @Override
        public int compareTo(CodeQLService.Version other) {
